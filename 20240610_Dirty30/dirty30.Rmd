...
time_v2 <- tokens %>% 
  ...
  labs(
    ...
    theme(
      text = element_text(color = '#f2d66b', family = 'Asap SemiCondensed'),
      axis.text = element_text(color = '#f2d66b', size = 12),
...
dirty_count <- tokens %>% 
  ...
  ggplot(aes(x = fct_reorder(word, n), y = n)) + 
    ...
    labs(
        x = "",
        y = "# of Utterances",
        title = "The <i><b>DIRTIEST</b></i> Words?"
      ) + 
